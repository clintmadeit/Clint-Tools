...
TARBALL_URL = ("https://github.com/clinttoolsaudio/clinttools/archive"
    "/{}".format(TARBALL_NAME))
...
License:        GPLv3
URL:            http://github.com/clinttoolsaudio/clinttools/
Source0:        {2}
...
%description
clinttools is digital audio workstations (DAWs), instrument and effect plugins
